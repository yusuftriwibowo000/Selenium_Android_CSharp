...
namespace LibraryPDF
{
    public class LibPDF
    {
        ...
        public static void CreateDocumentAttributes()
        {
            ...
            Cell titleApp     = new Cell().Add(new Paragraph("Application").SetFontSize(10).SetBold());
            Cell titleAppVersion = new Cell().Add(new Paragraph("App Version").SetFontSize(10).SetBold());
            ...
            Cell app = new Cell().Add(new Paragraph(LibExcel.GetDataExcel(globalExcelFilePath, "APPLICATION", "Global")).SetFontSize(10));
            Cell appVersion = new Cell().Add(new Paragraph(LibExcel.GetDataExcel(globalExcelFilePath, "APP_VERSION", "Global")).SetFontSize(10));
            ...
            tableDocAttr.AddCell(titleApp);
            tableDocAttr.AddCell(app);
            tableDocAttr.AddCell(titleAppVersion);
            tableDocAttr.AddCell(appVersion);
        ...
        public static void AddScreenshotToPDF(string imagePath, string descImage, string stepStatus)
        {
            ...
            if (verticalPosition < 290f) // Jika sisa space halaman < 200f
            {
            ...
            Image img = new Image(ImageDataFactory
                ...
                .ScaleAbsolute(290f, 540f)
                .SetFixedPosition(centerX-50, verticalPosition-250 ,500)
                .SetMarginBottom(20f);

            verticalPosition -= 290f; // Adjust this value based on the space you want between contents
